<%-- 
    Document   : nav.jsp
    Created on : Aug 23, 2016, 11:05:06 AM
    Author     : shivakumar.m
--%>
<ul class="menu-links">
    <li icon="md md-blur-on"> <a ui-sref="main.home.dashboard"><i class="md md-dashboard"></i>&nbsp;<span>Dashboard</span></a></li>
    
    <li name="samplePage"><a ui-sref="main.home.sample"><i class="md md-web"></i>&nbsp;<span>Sample Page</span></a></li>
